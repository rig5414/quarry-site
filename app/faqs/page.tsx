        ...
        <div className="container py-12 md:py-16">
          <div className="max-w-3xl mx-auto">
            ...
            <Accordion type="single" collapsible className="mb-12">
              ...
              <AccordionTrigger className="text-lg font-medium text-quarry-text hover:text-quarry-accent3 group">
                  <div className="flex items-center">
                    <Megaphone className="h-5 w-5 mr-2 text-quarry-accent2 group-hover:text-quarry-accent3 transition-colors" />
                    <span>What types of stone products do you offer?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground text-black text-base">
              ...
              <AccordionTrigger className="text-lg font-medium text-quarry-text hover:text-quarry-accent3 group">
                  <div className="flex items-center">
                    <Megaphone className="h-5 w-5 mr-2 text-quarry-accent2 group-hover:text-quarry-accent3 transition-colors" />
                    <span>Do you deliver to all areas in Kenya?</span>
                  </div>
                </AccordionTrigger>
              ...
              <AccordionTrigger className="text-lg font-medium text-quarry-text hover:text-quarry-accent3 group">
                  <div className="flex items-center">
                    <Megaphone className="h-5 w-5 mr-2 text-quarry-accent2 group-hover:text-quarry-accent3 transition-colors" />
                    <span>Do you offer consultation services?</span>
                  </div>
                  </AccordionTrigger>
                <AccordionContent className="text-muted-foreground text-base text-color">
              ...
              <AccordionTrigger className="text-lg font-medium text-quarry-text hover:text-quarry-accent3 group">
                  <div className="flex items-center">
                    <Megaphone className="h-5 w-5 mr-2 text-quarry-accent2 group-hover:text-quarry-accent3 transition-colors" />
                    <span>Can I visit your quarry site?</span>
                  </div>
                  </AccordionTrigger>
                <AccordionContent className="text-muted-foreground text-base text-black">
